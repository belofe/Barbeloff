...
class Rookie(commands.Cog):
    ...
    @commands.command()
    async def rookie(self, ctx):
        """Rookie workout type selection"""
        ...
        class WorkoutView(discord.ui.View):
            def __init__(self, rookie_cog):
                super().__init__(timeout=60.0)
                self.rookie_cog = rookie_cog
...
- **Machine Shoulder Press:** 2 sets of 8 - 12 reps
- **Pec Fly:** 2 sets of 12 - 15 reps
- **Lateral Raise (cable/dumbbell/machine):** 2 sets of 8 - 12 reps
- **Cable Tricep Pushdown:** 3 sets of 8 - 12 reps
- **Cable Tricep Kickback:** 2 sets of 8 - 12 reps
...
- **Burpees:** 2 sets of 6 - 10 reps
- **Cool-down Cardio:** steady paced walking or jogging for 10 minutes     
...
- Wall or Incline Push ups: 2 sets of 6-10 reps
- Seated or Standing Rows: 2 sets of 8-12 reps
- Overhead Press: 2 sets of 8-10 reps
- Chair Tricep Dips: 2 sets of 5-8 reps
- Bicep Curls: 2 sets of 8-12 reps
- Dead Bug Exercise: 2 sets of 6-8 each side

**Cardio (15-20 minutes):**
- Interval walking: alternate 2 minutes normal pace with 1 minute brisk pace
- Or steady-state cardio of your choice
"""
...
- Stationary lunge: 2 sets of 6-8 each leg
